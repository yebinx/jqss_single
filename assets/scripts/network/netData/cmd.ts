...
export var mssCmd = {
    ...
    CMD_S_GameEnd:function(){
        ...
        this.nIconAfterWildFill= create2DTypeArray(mssCmd.ROW,mssCmd.COL, mssCmd.NodeTypeInfo);
        this.nMaxWildRowCount= createTypeArray(mssCmd.COL, BYTE);//列的最大行数 可变行2~7
